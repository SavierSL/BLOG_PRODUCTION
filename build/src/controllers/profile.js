...
var ProfileCTRL = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userID, body, profile, newProfile, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                profile = __assign({ user: userID }, body);
                newProfile = new Profile_1.Profile(profile);
